...
const rowDOM = document.querySelector(".add-row");
...
function computeSemesterGPA() {
  ...
  resultGPA.innerHTML = `<h4 class="sem-gpa">Your Semester GPA is:${sumOfQualityPoints}</h4><p>Total Credit Hours:${sumCred}</p>`;
